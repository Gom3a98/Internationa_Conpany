			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="social-icons">
						<h4>Follow Us</h4>
						<ul>
							<li><a href="#" target="_blank"><img src="{{ asset('user/images/facebook.png')}}" alt="" /></a>
							</li>
							<li><a href="#" target="_blank"><img src="{{ asset('user/images/twitter.png')}}" alt="" /></a>
							</li>
							<li><a href="#" target="_blank"><img src="{{ asset('user/images/skype.png')}}" alt="" /> </a>
							</li>
							<li><a href="#" target="_blank"> <img src="{{ asset('user/images/dribbble.png')}}" alt="" /></a>
							</li>
							<li><a href="#" target="_blank"> <img src="{{ asset('user/images/linkedin.png')}}" alt="" /></a>
							</li>
							<div class="clear"></div>
						</ul>
					</div>
